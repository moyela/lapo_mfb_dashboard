...
import LogComplaintModal from '../../components/complaints/LogComplaintModal';
...
const ComplaintsLog = () => {
  ...
  return (
    <div className="space-y-4 font-[Satoshi]">
      <div>
        <h1 className="text-2xl font-semibold text-gray-800">Complaints: Log</h1>
      ...
      <ComplaintsTable status={activeTab} searchQuery={searchQuery} basePath="log" />
      {showModal && <LogComplaintModal onClose={() => setShowModal(false)} />}
